                ...
                <div className='stepDescriptionBox'>
                    <div className='tutorialBox'>
                        ...
                        <span>
                            ...
                            <span className='code'> ayva deploy</span>. This will push <span className='ayvaHighlight'>Hello Ayva's</span> pre-defined interaction models 
                            to the Dialogflow agent <a href='#stepThree' className='stepHighlight'>(created in Step 3)</a>.</span>
                    </div>
                    <div className='tutorialBox'>
                        <h3>6b. Run Hello Ayva in development mode</h3>
                        <Terminal code='npm start' />
                        <span>To start the voice app service, run <span className='code'>npm start</span> in the root of your <span className='ayvaHighlight'>Hello Ayva</span> project folder.</span> 
