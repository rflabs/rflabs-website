                ...
                <div className='mainOne'>
                    <div className='ayvaDescription'>
                        ...
                        <div className='ayvaOverview'>
                            <span><span className='ayva'>Ayva</span> is an open-source cross-platform developer framework used to build voice assistant applications. The features and tools provided in this framework are platform agnostic, allowing developers to build their app once and deploy on both Google Assistant and Alexa.</span>
                        </div>
